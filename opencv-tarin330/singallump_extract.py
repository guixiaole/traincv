...
def find_crop_center_pos1(crop, boxs, left_center_pos, right_center_pos, ipx_threshold, last_pos, flag, jianju):
    ...
    if crop[left_center_pos_][right_center_pos_][0] >= ipx_threshold:
        ...
        left_center_pos, right_center_pos = find_crop_center_pos(crop, boxs, left_center_pos, right_center_pos,
                                                                 ipx_threshold, last_pos, -flag, abs(jianju) + 1)
...
def replace_lump_pos(boxs, image):
    ...
    # lump_box=[11,9,8,8]
    print(lump_box)
    crop2 = image[boxs[1] + lump_box[1]:boxs[1] + lump_box[1] + lump_box[3],
            boxs[0] + lump_box[0]:boxs[0] + lump_box[0] + lump_box[2]]
    cv2.imshow('crop2', crop2)
